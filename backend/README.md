...
## Project Structure
    ...
    ├── testapiautosettings_89272  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_89272`
...
2. Clone this repo and `cd testapiautosettings_89272`
